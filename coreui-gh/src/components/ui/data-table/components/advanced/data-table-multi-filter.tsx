...
import type { DataTableFilterOption } from "@/components/ui/data-table/types"
import {
  CopyIcon,
  DotsHorizontalIcon,
  TextAlignCenterIcon,
...
export function DataTableMultiFilter<TData>({
  ...
  const [operator, setOperator] = React.useState<{ label: string; value: string; } | undefined>(operators[0])
